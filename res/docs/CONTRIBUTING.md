...
### Reporting Bugs
- Use the [Bug Report Template](https://github.com/lenny-ts/league_profile_tool/issues/new?template=bug_report.md).
...
- Use the [Feature Request Template](https://github.com/lenny-ts/league_profile_tool/issues/new?template=feature_request.md).
